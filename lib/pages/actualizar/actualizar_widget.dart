...
import 'actualizar_model.dart';
export 'actualizar_model.dart';

class ActualizarWidget extends StatefulWidget {
  const ActualizarWidget({super.key});

  @override
  State<ActualizarWidget> createState() => _ActualizarWidgetState();
}

class _ActualizarWidgetState extends State<ActualizarWidget> {
  late ActualizarModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ActualizarModel());

    logFirebaseEvent('screen_view', parameters: {'screen_name': 'Actualizar'});
                  ...
                  children: [
                          ...
                          children: [
                            ...
                            Align(
                              ...
                              child: FlutterFlowDropDown<String>(
                                controller: _model.tipoidValueController ??=
                                    FormFieldController<String>(
                                  _model.tipoidValue ??= 'Cédula de ciudadanía',
                                ),
                                options: const [
                                ...
                                onChanged: (val) =>
                                    setState(() => _model.tipoidValue = val),
                                width: 500.0,
                                height: 56.0,
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        ...
                                        FlutterFlowIconButton(
                                          ...
                                          onPressed: () async {
                                            logFirebaseEvent(
                                                'ACTUALIZAR_calendar_month_ICN_ON_TAP');
                                            logFirebaseEvent(
                    ...
                    Padding(
                      ...
                      child: FFButtonWidget(
                        onPressed: () async {
                          logFirebaseEvent(
                              'ACTUALIZAR_ACTUALIZAR_USUARIO_BTN_ON_TAP');
                          ...
                          if (functions.stringContains(
                                  _model.resultadoFunc!, 'verificar') ||
                              functions.stringContains(
                                  _model.resultadoFunc!, 'exito')) {
                            if (functions.stringContains(
                                _model.resultadoFunc!, 'verificar')) {
                              if (functions.stringContains(
                                  _model.resultadoFunc!, 'vacio')) {
                                logFirebaseEvent('Button_show_snack_bar');
                                ScaffoldMessenger.of(context).clearSnackBars();
                                ScaffoldMessenger.of(context).showSnackBar(
                                  SnackBar(
                                    content: Text(
                                      'Los nombres y apellidos no pueden consistir solo de espacios',
                                      style: TextStyle(
                                        color: FlutterFlowTheme.of(context)
                                            .primaryBackground,
                                      ),
                                ...
                                if (functions.stringContains(
                                  ...
                                  if (functions.stringContains(
                                      _model.resultadoFunc!, 'incompleto')) {
                                    logFirebaseEvent('Button_show_snack_bar');
                                    ScaffoldMessenger.of(context)
                                        .clearSnackBars();
                                    ScaffoldMessenger.of(context).showSnackBar(
                                      SnackBar(
                                        content: Text(
                                          'Los campos que intentas editar contienen los mismos datos que ya están registrados. Por favor, realiza los cambios necesarios e intenta nuevamente.',
                                          style: TextStyle(
                                            color: FlutterFlowTheme.of(context)
                                                .primaryBackground,
                                          ),
                                    ...
                                    if (functions.stringContains(
                                        _model.resultadoFunc!, 'inexistente')) {
                                      logFirebaseEvent('Button_show_snack_bar');
                                      ScaffoldMessenger.of(context)
                                          .clearSnackBars();
                                      ScaffoldMessenger.of(context)
                                        ...
                                        SnackBar(
                                          content: Text(
                                            'El documento ingresado no ha sido registrado',
                                            style: TextStyle(
                                              color:
                                                  FlutterFlowTheme.of(context)
                                                      .primaryBackground,
                            ...
                            ScaffoldMessenger.of(context).showSnackBar(
                              SnackBar(
                                content: Text(
                                  'Este servicio no está disponible por le momento, por favor intenta más tarde.',
                                  style: TextStyle(
                                    color: FlutterFlowTheme.of(context)
                                        .primaryBackground,
                                  ),
