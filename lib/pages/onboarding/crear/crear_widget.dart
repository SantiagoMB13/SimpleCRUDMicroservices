...
class _CrearWidgetState extends State<CrearWidget> {
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view', parameters: {'screen_name': 'Crear'});
    // On page load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      logFirebaseEvent('CREAR_PAGE_Crear_ON_INIT_STATE');
      logFirebaseEvent('Crear_auth');
      GoRouter.of(context).prepareAuthEvent();

      final user = await authManager.signInWithEmail(
        context,
        'sabarandica@uninorte.edu.co',
        'claveprueba',
      );
      if (user == null) {
        return;
      ...
      context.goNamedAuth('Crear', context.mounted);
    });
                  ...
                  children: [
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      ...
                                      FlutterFlowIconButton(
                                        ...
                                        onPressed: () async {
                                          logFirebaseEvent(
                                              'CREAR_PAGE_calendar_month_ICN_ON_TAP');
                                          logFirebaseEvent(
                    ...
                    Padding(
                      ...
                      child: FFButtonWidget(
                        onPressed: () async {
                          logFirebaseEvent(
                              'CREAR_PAGE_CREAR_USUARIO_BTN_ON_TAP');
                          var shouldSetState = false;
                          if (_model.secondnameTextController.text == '') {
                          ...
                          _model.resultadoFunc =
                              await actions.callCreateFunction(
                            _model.uploadedFileUrl,
                            _model.tipoidValue!,
                          ...
                          if (functions.stringContains(
                            ...
                            if (functions.stringContains(
                              ...
                              if (functions.stringContains(
                                  _model.resultadoFunc!, 'repetido')) {
                                logFirebaseEvent('Button_show_snack_bar');
                                ScaffoldMessenger.of(context).clearSnackBars();
                                ScaffoldMessenger.of(context).showSnackBar(
                                  SnackBar(
                                    content: Text(
                                      'El documento ingresado ya ha sido registrado',
                                      style: TextStyle(
                                        color: FlutterFlowTheme.of(context)
                                            .primaryBackground,
                                      ),
